...
import "./Actuales.css";
import tempImage from "../img/temp.png"; // Ruta relativa desde TemperatureInfo.js al archivo temp.png
import TemperatureInfoBox from "./TempatureInfoBox";
  ...
  return (
    <div className="actuales">
      ...
      <div className="center-vertically">
        ...
        <img src={tempImage} alt="Descripción de la imagen" />
      </div>
      <div className="temperature-info-container">
        {" "}
        {/* Aplica la clase CSS aquí */}
